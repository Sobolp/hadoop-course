...
create schema taxi_facts;

drop table taxi_facts.taxi_facts;
...
ALTER TABLE taxi_facts.taxi_facts SET ('skip.header.line.count'='1');

SHOW PARTITIONS taxi_facts.taxi_facts;

msck repair table taxi_facts.taxi_facts;
analyze table taxi_facts.taxi_facts partition(`date`) compute statistics noscan;
